...
for subject in "${subjects[@]}"; do
    ...
    mkdir -p ${path_out}/${subject}/ses-ses-spinalcord/func/
    cd ${path_out}/${subject}/ses-ses-spinalcord/func/
    file_path="${path_in}/${subject}/ses-ses-spinalcord/func/${subject}_ses-spinalcord_task-tens_run-average_bold_mc2_pnm_stc2template_smooth225_trialwise_second_level.gfeat"
    #Copy functional
    ret=1
    c=0
    until [ ${ret} = 0 ] || [ ${c} = 5 ]; do
