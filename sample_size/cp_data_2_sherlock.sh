...
for subject in "${subjects[@]}"; do
    ...
    if [ "${run}" = "average" ]; then
        file_path="${path_in}/${subject}/ses-spinalcord/func/${subject}_ses-spinalcord_task-tens_run-${run}_bold_mc2_pnm_stc2template_smooth225_trialwise_second_level.gfeat"
    else
