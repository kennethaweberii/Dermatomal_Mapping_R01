...
PATH_DATA=${SCRATCH}/dmr01/derivatives/mppca/DM_R01/
PATH_SEGMANUAL=${SCRATCH}/dmr01/derivatives/labels
output_path=${SCRATCH}/dmr01/mppca_preprocessing_2026-03-11
...
subjects=(sub-DMAim1HC028 sub-DMAim1HC039 sub-DMAim1HC052) 
ses=ses-spinalcord
time_limit=40:00:00
memory=128000
