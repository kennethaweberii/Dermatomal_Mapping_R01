...
PATH_DATA=${SCRATCH}/dmr01/derivatives/nordic_param_fe1.2/DM_R01/
PATH_SEGMANUAL=${SCRATCH}/dmr01/derivatives/labels
output_path=${SCRATCH}/dmr01/nordic_param_fe1.2_preprocessing_2026-03-09
...
#subjects=(sub-DMAim1HC045 sub-DMAim1HC047 sub-DMAim1HC046 sub-DMAim1HC039) 
ses=ses-spinalcord
time_limit=30:00:00
memory=128000
